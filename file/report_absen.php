...
$pdf->ln(4);
$pdf->Cell(170,6,"Data absen ".$j.". Tahun pelajaran ".$s,0,1);
$pdf->ln(4);
$i=1;
...
$data = mysql_query("SELECT * FROM siswa, tabel_absen WHERE siswa.id_siswa = tabel_absen.id_siswa 
													  AND siswa.tahun_pelajaran='$s' 
													  AND siswa.program_keahlian = '$j'");
while ( $a = mysql_fetch_array($data)) {
	$pdf->Cell(7,6,$i,1,0,'C');
	$pdf->Cell(45,6,$a['nama_siswa'],1,0);
	$pdf->Cell(30,6,$a['tanggal'],1,0,'C');
	$pdf->Cell(30,6,$a['keterangan'],1,0);
	$pdf->Cell(30,6,$a['jam_masuk'],1,0,'C');
...
$pdf->SetTitle('Laporan Absen Prakerin Siswa');
