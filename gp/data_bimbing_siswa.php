    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Data Siswa Praktek Kerja Industri</h3>
        </div>
        <!-- /.box-header -->
        <hr>
        <div style="padding-left: 11px;" class="form-inline">
          ...
          <?php
            if (isset($_POST['cari'])) {
              ...
              echo '<script>window.location="index.php?guru&p=list_bimbingan&s='.$seleksitahun.'"</script>';
            }
          ?>
          </div>
          <hr>
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              if ((isset($_GET['s'])) and ($_GET['s']!=''))  {
                  ...
                  $tp=mysql_query("SELECT * FROM siswa, usulan_dudi, guru_pembimbing WHERE siswa.id_siswa = guru_pembimbing.id_siswa AND siswa.id_siswa = usulan_dudi.id_siswa AND usulan_dudi.status = 'acc' AND siswa.tahun_pelajaran='$ss' AND guru_pembimbing.id_guru = '$_SESSION[username]'");
                } else {
                  $tp=mysql_query("SELECT * FROM siswa, guru, guru_pembimbing WHERE siswa.id_siswa = guru_pembimbing.id_siswa AND guru.id_guru=guru_pembimbing.id_guru AND guru.id_guru = '$_SESSION[username]'");
                }
              // $tp=mysql_query("SELECT * FROM siswa, guru, guru_pembimbing WHERE siswa.id_siswa = guru_pembimbing.id_siswa AND guru.id_guru=guru_pembimbing.id_guru AND guru.id_guru = '$_SESSION[username]'");
              ...
              while($r=mysql_fetch_array($tp)){
                ...
                <tr> 
                  ...
                  <td>
                    <a class= 'btn btn-primary' href="?guru&p=list_bimbingan_lanjut&siswa=<?php echo $r['id_siswa']?>"> <i class='fa fa-television '></i>Absen</a>
                  </td>
                </tr>
                <?php 
                  $i++;
