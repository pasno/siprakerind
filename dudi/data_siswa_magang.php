   ...
   <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <!-- /.box-header -->
        <hr>
        <div class="form-inline" style="padding-left: 11px;">
            ...
            <tbody>
              ...
              while($r=mysql_fetch_array($tp)){
                ...
                <tr> 
                  ...
                  <td>
                    <a class= 'btn btn-primary' href="?dudi&p=absen_siswa&siswa=<?php echo $r['id_siswa']?>"> <i class='fa fa-television '></i>Absen</a>
                  </td>
                </tr>
                <?php 
                  $i++;
